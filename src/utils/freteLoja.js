...
export const isCapital = (estado, cidade) => {
...
export const computeFreteLoja = (estado, pesoKg, cidade) => {
  const uf = (estado || "").toUpperCase().trim();
  if (!uf) return null;
